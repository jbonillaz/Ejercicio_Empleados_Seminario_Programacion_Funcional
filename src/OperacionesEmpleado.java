...
public class OperacionesEmpleado {
    ...
    public static void inicializarLista(){
        ...
        listaEmpleados.add(new Empleado(1,"John Fredy","Bonilla Zamora",400.000));
        listaEmpleados.add(new Empleado(2,"Carlos Arnulfo","Cogua",300.000));
        listaEmpleados.add(new Empleado(3,"Karen Dayana","Nossa",700.000));
        listaEmpleados.add(new Empleado(4,"Lina Maria","Rozo",900.000));
        listaEmpleados.add(new Empleado(5,"Sebastian","Bonilla",810.000));
        listaEmpleados.add(new Empleado(6,"Camilo Andres","Acosta",960.000));
        listaEmpleados.add(new Empleado(7,"Elizabeth","Acevedo",1200.000));
    }
    ...
    public static void mostrarEmpleadoConMenorSueldo() {//Encontrar empleado con menor sueldo
    ...
    public static void mostrarEmpleadosConApellidoQueEmpiezaConA(){
